document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateSelectedOptions(customSelect) {
        ...
        if (selectedOptions.length === 0) {
            ...
            if (additionalTagsCount > 0) {
                tagsHTML += '<span class="tag">+ ' + additionalTagsCount + ' more</span>';
            }
        }

        customSelect.querySelector(".selected-options").innerHTML = tagsHTML; // Corrected to innerHTML
    }
    ...
    customSelects.forEach(function (customSelect) {
        ...
        allTagsOption.addEventListener("click", function () {
            const isActive = allTagsOption.classList.contains("active"); // Corrected
        ...
        clearButton.addEventListener("click", function () { // Corrected
            searchInput.value = "";
            options.forEach(function (option) { // Corrected
        ...
        searchInput.addEventListener("input", function () {
            ...
            if (searchTerm) {
                optionsContainer.classList.add("option-search-active"); // Corrected
            } else {
    ...
    selectBoxes.forEach(function (selectBox) {
        selectBox.addEventListener("click", function (event) { // Corrected
